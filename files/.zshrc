...
if [[ ! -e ~/.config/zsh/zsh-autoswitch-virtualenv ]]; then
  git clone https://github.com/MichaelAquilina/zsh-autoswitch-virtualenv.git ~/.config/zsh/zsh-autoswitch-virtualenv
fi
...
function edit(){
  if [ "$1" = "v" ]; then
    cd "/home/leo/.config/nvim" || echo "nvim not found"
    return
  fi
